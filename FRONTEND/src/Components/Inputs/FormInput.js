        ...
        <div>
          <div className="relative mt-2">
            <input
              ...
              ref={ref}
              autoComplete={type === "password" ? "false" : "true"}
              className={`block px-2.5 pb-1.5 pt-3 w-full text-sm text-gray-900 bg-transparent rounded-lg border-2 border-gray-200 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer ${className}`}
              placeholder={placeholder || ""}
            />
            {type === "password" && (
              <div
