...
const ProductDetails = () => {
  ...
  useLayoutEffect(() => {
    ...
    dispatch({
      type: SellerProductActionRequest.GET_SINGLE_PRODUCT_SAGA_REQUEST,
      payload: id,
    });
  }, [
    dispatch,
  ...
  const handleOnImageUlploadMultiple = () => {
    ...
    dispatch({
      type: SellerProductActionRequest.UPDATE_SELLER_MULTIPLE_IMAGES_SAGA_REQUEST,
      payload: { id, images },
    });
  };
  const handleOnUpdateDetails = () => {
    ...
    dispatch({
      type: SellerProductActionRequest.UPDATE_SELLER_PRODUCTS_SAGA_REQUEST,
      payload: {
        id,
        formData,
      },
  ...
  const UpdateBrandLogo = () => {
    ...
    dispatch({
      type: SellerProductActionRequest.UPDATE_SELLER_BRAND_LOGO_SAGA_REQUEST,
  ...
  const UpdateThumbnail = () => {
    ...
    dispatch({
      type: SellerProductActionRequest.UPDATE_SELLER_THUMBNAIL_SAGA_REQUEST,
      payload: { id, thumb },
    });
  };
  ...
  const handleOnProductDelete = () => {
    dispatch({
      type: SellerProductActionRequest.DELETE_SELLER_PRODUCT_SAGA_REQUEST,
      payload: id,
    });
  };
  useEffect(() => {
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-2 col-span-12 gap-3 lg:col-span-7">
                ...
                <div className="flex items-center space-x-6 ">
                  ...
                  >
                    <img
                      className="object-cover w-16 h-16 bg-black rounded-full"
                      src={
                ...
                <div className="flex items-center space-x-6">
                  <div className="rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                    <img
                      ...
                      className="object-cover w-16 h-16 bg-black rounded-full cursor-pointer"
                      src={
                      ...
                      product?.product?.images.map((image, index) => {
                        return (
                          <div key={index} className=" avatar">
                            <div className="w-12 bg-black rounded-full ring-primary ring ring-offset-base-100 ring-offset-2">
                              <img
                                src={image.img}
                                alt="Current profile"
                                loading="lazy"
